...
const CATALOGUE: Record<string, CatalogueExercise> = {
  ...
  'straight-arm-pulldown': { name: 'Straight-arm pulldown', measures: ['weightReps', 'reps'] },
  ...
  'mu-transition': { name: 'Muscle-up transition drill', measures: ['reps', 'band'], aliases: ['transition'] },
  ...
  'burpee-broad-jump': { name: 'Burpee broad jump', measures: ['reps', 'time'] },
  ...
  'db-ground-to-overhead': { name: 'Dumbbell ground-to-overhead', measures: ['reps', 'weightReps'], aliases: ['G2O'] },
